                        ...
                        <div class="container ms-2">
                            <form action="{{ url('/send-data-diri') }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tempat_lahir" name="Tempat_lahir" value="{{ old('Tempat_lahir') }}" placeholder="Pasuruan">
                                </div>

                                {{-- tanggal lahir --}}
                                <div class="mb-3">
                                    <label for="tanggal_lahir" class="form-label">Kota/Kab Tempat Lahir</label>
